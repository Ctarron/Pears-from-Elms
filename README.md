# Pears-from-Elms
Grow plants while tending to the shops. Harvest them and chop them down. But don't wait too long or the crops will be ruined.

[![Latest Release](https://img.shields.io/github/v/release/Ctarron/Pears-from-Elms?label=version&color=green)](https://github.com/Ctarron/Pears-from-Elms/releases/latest)

[Ctarron discord](https://discord.gg/Ur6SKQ3qjV) server for feedback/doubts.

Also on [Minecraft Maps](https://www.minecraftmaps.com/52582-pears-from-elms)

Also on [Planet Minecraft](https://www.planetminecraft.com/project/pears-from-elms/)
